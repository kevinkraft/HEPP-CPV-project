...
\begin{abstract}
\textit{The theory of CP violation is best explained through the mechanism of the CKM matrix. The mixing of the transitions in quark decays leads to complex phases that contribute to the Unitary triangles. The three angles $\alpha$ ,$\beta$ and $\gamma$ that these triangle are composed of are measurable and provide information on the scale of CPV.This theory is a basis for calculations of Weak interactions and developments of deeper understanding behind CPV in the Standard Model.}
\end{abstract}
